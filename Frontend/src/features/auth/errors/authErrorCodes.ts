...
export const AUTH_PASSWORD_RESET_LINK_INVALID_OR_EXPIRED = "AUTH_PASSWORD_RESET_LINK_INVALID_OR_EXPIRED"
export const AUTH_PASSWORD_RESET_FAILED = "AUTH_PASSWORD_RESET_FAILED"
export const AUTH_PASSWORD_RESET_PASSWORD_MISMATCH = "AUTH_PASSWORD_RESET_PASSWORD_MISMATCH"

export type VerifyPasswordResetTokenErrorCode =
    typeof AUTH_PASSWORD_MIN_LENGTH
    | typeof AUTH_PASSWORD_RESET_PASSWORD_MISMATCH
    | typeof AUTH_PASSWORD_RESET_LINK_INVALID_OR_EXPIRED
    | typeof AUTH_USER_NOT_FOUND
